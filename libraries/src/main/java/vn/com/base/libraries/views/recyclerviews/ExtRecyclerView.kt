...
import vn.com.base.libraries.models.IModel
...
class ExtRecyclerView<T : IModel, VH : ExtRecyclerViewHolder> : LinearLayout {
    ...
    private fun initView(context: Context, attrs: AttributeSet?) {
        ...
        swSwipeRefreshLayout.setColorSchemeColors(
            typedArray.getColor(
                R.styleable.ExtRecyclerView_rvSwipeRefreshIndicatorColor,
                ContextCompat.getColor(context, R.color.colorAccent)
            )
        )

        // scroll bar visibility
        rvRecyclerView.isVerticalScrollBarEnabled =
            typedArray.getBoolean(R.styleable.ExtRecyclerView_rvScrollbarVisible, false)

        // message no data
        StringUtility.with(typedArray.getString(R.styleable.ExtRecyclerView_rvNoDataMessage))
            .doIfPresent { tvMessage.text = it }
        typedArray.recycle()
    }
