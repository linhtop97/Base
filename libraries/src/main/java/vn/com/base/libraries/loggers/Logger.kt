package vn.com.base.libraries.loggers
...
class Logger {
    companion object {
        ...
        fun d(msg: String?) {
            if (isEnableLog) {
                Log.d(tagDefault, buildMessage(Companion.TypeLog.DEBUG, tagDefault, msg))
            }
        }
        ...
        fun d(ex: Exception?) {
            if (isEnableLog) {
                Log.d(tagDefault, buildMessage(Companion.TypeLog.DEBUG, tagDefault, getMessageException(ex)))
            }
        }
        ...
        fun d(tag: String?, msg: String?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { d(msg) }
                        .doIfPresent { Log.d(tag, buildMessage(Companion.TypeLog.DEBUG, tag, msg)) }
            }
        }
        ...
        fun d(tag: String?, ex: Exception?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { d(ex) }
                        .doIfPresent { Log.d(tag, buildMessage(Companion.TypeLog.DEBUG, tag, getMessageException(ex))) }
            }
        }
        ...
        fun e(msg: String?) {
            if (isEnableLog) {
                Log.e(tagDefault, buildMessage(Companion.TypeLog.ERROR, tagDefault, msg))
            }
        }
        ...
        fun e(ex: Exception?) {
            if (isEnableLog) {
                Log.e(tagDefault, buildMessage(Companion.TypeLog.ERROR, tagDefault, getMessageException(ex)))
            }
        }
        ...
        fun e(tag: String?, msg: String?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { e(msg) }
                        .doIfPresent { Log.e(tag, buildMessage(Companion.TypeLog.ERROR, tag, msg)) }
            }
        }
        ...
        fun e(tag: String?, ex: Exception?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { e(ex) }
                        .doIfPresent { Log.e(tag, buildMessage(Companion.TypeLog.ERROR, tag, getMessageException(ex))) }
            }
        }
        ...
        fun i(tag: String?, msg: String?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { i(msg) }
                        .doIfPresent { Log.i(tag, buildMessage(Companion.TypeLog.INFO, tag, msg)) }
            }
        }
        ...
        fun i(tag: String?, ex: Exception?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { i(ex) }
                        .doIfPresent { Log.i(tag, buildMessage(Companion.TypeLog.INFO, tag, getMessageException(ex))) }
            }
        }
        ...
        fun i(msg: String?) {
            if (isEnableLog) {
                Log.i(tagDefault, buildMessage(Companion.TypeLog.INFO, tagDefault, msg))
            }
        }
        ...
        fun i(ex: Exception?) {
            if (isEnableLog) {
                Log.i(tagDefault, buildMessage(Companion.TypeLog.INFO, tagDefault, getMessageException(ex)))
            }
        }
        ...
        fun v(tag: String?, msg: String?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { v(msg) }
                        .doIfPresent { Log.v(tag, buildMessage(Companion.TypeLog.VERBOSE, tag, msg)) }
            }
        }
        ...
        fun v(tag: String?, ex: Exception?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { v(ex) }
                        .doIfPresent { Log.v(tag, buildMessage(Companion.TypeLog.VERBOSE, tag, getMessageException(ex))) }
            }
        }
        ...
        fun v(msg: String?) {
            if (isEnableLog) {
                Log.v(tagDefault, buildMessage(Companion.TypeLog.VERBOSE, tagDefault, msg))
            }
        }
        ...
        fun v(ex: Exception?) {
            if (isEnableLog) {
                Log.v(tagDefault, buildMessage(Companion.TypeLog.VERBOSE, tagDefault, getMessageException(ex)))
            }
        }
        ...
        fun w(tag: String?, msg: String?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { w(msg) }
                        .doIfPresent { Log.w(tag, buildMessage(Companion.TypeLog.WARN, tag, msg)) }
            }
        }
        ...
        fun w(tag: String?, ex: Exception?) {
            if (isEnableLog) {
                StringUtility.with(tag)
                        .doIfEmpty { w(ex) }
                        .doIfPresent { Log.w(tag, buildMessage(Companion.TypeLog.WARN, tag, getMessageException(ex))) }
            }
        }
        ...
        fun w(msg: String?) {
            if (isEnableLog) {
                Log.w(tagDefault, buildMessage(Companion.TypeLog.WARN, tagDefault, msg))
            }
        }
        ...
        fun w(ex: Exception?) {
            if (isEnableLog) {
                Log.w(tagDefault, buildMessage(Companion.TypeLog.WARN, tagDefault, getMessageException(ex)))
            }
        }
        ...
        fun setEnableLog(isEnableLog: Boolean) {
            Companion.isEnableLog = isEnableLog
        }
        ...
        fun setPathSaveLog(dirPath: String, name: String,
                           suffix: String) {
            Companion.dirPath = dirPath
            Companion.name = name
            Companion.suffix = suffix
